...
| ⚓ Project | 💡 Description |
|----------|--------------|
| 🌸 **Lily** | AI Robot (ASR + RAG + emotion detection) |
| 🚑 **MedRoute AI** | Emergency routing (20 min → 3 sec) |
| ☁️ **Bedrock FinOps AI** | Auto-generated enterprise reports |
| ♿ **THRIVE** | AI job platform for PWDs |

---

### 🏅 Achievements

- 🥈 Globe Telecom Hackathon 2025  
- 🌍 HackNation AI 2026  
- 🎖️ PLDT Innovation Gen Finalist  
- ✈️ Super AI Singapore Delegate  
...
<img width="100%" src="https://capsule-render.vercel.app/api?type=waving&color=0:e84545,100:f0c040&height=100&section=footer"/>
